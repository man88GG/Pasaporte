...
namespace CapaVista
{
    public partial class frmTipoTramite : Form
    {
        string UsuarioAplicacion;
        static Form FormularioPadre;
        public frmTipoTramite(string usuario, Form formularioPadre)
        {
            InitializeComponent();
        ...
        private void frmTipoTramite_Load(object sender, EventArgs e)
        {
        ...
        private void navegador1_Load(object sender, EventArgs e)
        {
            ...
            navegador1.ruta = "TipoTramite.html";
        }
    }
}
